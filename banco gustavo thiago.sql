...
select count(nomecid) from cidade;
...
select * from vendedor  order by salario desc limit 1;

## 07 - Quem possui o maior salário? 

select nomevend from vendedor  order by salario desc limit 1;

## 08 - Qual o menor salário dos vendedores? 

select * from vendedor  order by salario limit 1;

## 09 - Quem possui o menor salário? 

select nomevend from vendedor  order by salario limit 1;

## 10 - Qual pedido teve a maior venda em quantidade? 

select codprod,numped,qtdade from itempedido  order by qtdade desc limit 1;

## 11 - Qual pedido teve a menor venda em quantidade? 

select codprod,numped,qtdade from itempedido  order by qtdade limit 1;

## 12 - Qual o produto mais barato? 

select codprod,descricao,unidade,valor_un from produto  order by valor_un limit 1;

## 13 - Qual o produto mais caro? 

select codprod,descricao,unidade,valor_un from produto  order by valor_un desc limit 1;
...
WHERE codcli = (
  SELECT codcli
  FROM cliente
  WHERE nome = 'Estevan Pereira Cardoso'
);
